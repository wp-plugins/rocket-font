...
class Setting extends Feature {
	...
	public function enqueue() {
		...
		wp_enqueue_style(
	        'jsdelivr-group',
	        '//cdn.jsdelivr.net/g/jquery.powertip@1.2.0(css/jquery.powertip.min.css),jquery.nouislider@7.0.10(jquery.nouislider.min.css+jquery.nouislider.pips.min.css)'
	    );
		
		wp_enqueue_script(
	        'jsdelivr-group',
	        '//cdn.jsdelivr.net/g/select2@3.5.2(select2.min.js),jquery.minicolors@2.1.2(jquery.minicolors.min.js),jquery.powertip@1.2.0(jquery.powertip.min.js),jquery.nouislider@7.0.10(jquery.nouislider.all.min.js)',
	        array( 'jquery' ),
	        VERSION,
	        true
	    );
