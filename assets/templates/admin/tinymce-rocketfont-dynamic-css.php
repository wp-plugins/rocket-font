...
if(!empty($options['rocketfont_class_id_list'])) {
	...
	?>
	{font-family:<?php echo $selected_backup_font_info['font_name'] . "," . $double_qute . $selected_font_info['font_name'] . $double_qute; ?>, <?php if($selected_backup_font_info['generic_font_family']) { echo $selected_backup_font_info['generic_font_family'];}else{ echo "sans-serif";}?>;}
	<?php
}
