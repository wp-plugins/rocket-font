<style>
	...
	<div class="rocket-font-wrap">
			...
			<div class="rocketfont-plugin-setting">
				...
				<div data-pws-tab="font-cdn" data-pws-tab-name="<i class='fa fa-cog'></i> 옵션 (폰트가 설정대로 표시되지 않을 경우)">
					...
					<div>
						...
						<i class="fa fa-question-circle fa-c2x tooltips" title="<p>사용자 화면뿐만이 아닌 워드프레스 기본 에디터(Tinymce) 에서도 설정한 폰트를 사용할 수 있습니다. 기본값은 [사용하지 않음] 입니다.</p>"></i>
					</div>
				</div>
		...
		<div class="plugin-info">
			...
			<h4><i class="fa fa-medkit"></i> 개발자: <a href="http://in-web.co.kr" target="_blank">Qwerty</a></h4>
